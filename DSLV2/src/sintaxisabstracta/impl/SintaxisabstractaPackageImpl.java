...
import relaciones1.impl.Relaciones1PackageImpl;
...
public class SintaxisabstractaPackageImpl extends EPackageImpl implements SintaxisabstractaPackage {
	...
	public static SintaxisabstractaPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(Relaciones1Package.eNS_URI);
		Relaciones1PackageImpl theRelaciones1Package = (Relaciones1PackageImpl)(registeredPackage instanceof Relaciones1PackageImpl ? registeredPackage : Relaciones1Package.eINSTANCE);

		// Create package meta-data objects
		theSintaxisabstractaPackage.createPackageContents();
		theRelaciones1Package.createPackageContents();

		// Initialize created meta-data
		theSintaxisabstractaPackage.initializePackageContents();
		theRelaciones1Package.initializePackageContents();
	...
	public void initializePackageContents() {
		...
		Relaciones1Package theRelaciones1Package = (Relaciones1Package)EPackage.Registry.INSTANCE.getEPackage(Relaciones1Package.eNS_URI);
		...
		initEReference(getTabla_ThesintaxisAbstracta(), theRelaciones1Package.getSintaxisAbstracta(), theRelaciones1Package.getSintaxisAbstracta_TheTabla(), "thesintaxisAbstracta", null, 0, 1, Tabla.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTabla_ThesintaxisConcreta(), theRelaciones1Package.getSintaxisConcreta(), theRelaciones1Package.getSintaxisConcreta_TheTabla(), "thesintaxisConcreta", null, 0, 1, Tabla.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
