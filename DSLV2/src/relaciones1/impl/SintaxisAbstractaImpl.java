 ...
 * </p>
 * <ul>
 *   <li>{@link relaciones1.impl.SintaxisAbstractaImpl#getTheModelFactory <em>The Model Factory</em>}</li>
 *   <li>{@link relaciones1.impl.SintaxisAbstractaImpl#getTheTabla <em>The Tabla</em>}</li>
 *   <li>{@link relaciones1.impl.SintaxisAbstractaImpl#getSintaxisAbstracta <em>Sintaxis Abstracta</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SintaxisAbstractaImpl extends MinimalEObjectImpl.Container implements SintaxisAbstracta {
	...
	protected EClass eStaticClass() {
		return Relaciones1Package.Literals.SINTAXIS_ABSTRACTA;
	}
	...
	public ModelFactory getTheModelFactory() {
		if (eContainerFeatureID() != Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY) return null;
	...
	public NotificationChain basicSetTheModelFactory(ModelFactory newTheModelFactory, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTheModelFactory, Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY, msgs);
		return msgs;
	}
	...
	public void setTheModelFactory(ModelFactory newTheModelFactory) {
		if (newTheModelFactory != eInternalContainer() || (eContainerFeatureID() != Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY && newTheModelFactory != null)) {
			...
			if (newTheModelFactory != null)
				msgs = ((InternalEObject)newTheModelFactory).eInverseAdd(this, Relaciones1Package.MODEL_FACTORY__THESINTAXIS_ABSTRACTA, ModelFactory.class, msgs);
			msgs = basicSetTheModelFactory(newTheModelFactory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY, newTheModelFactory, newTheModelFactory));
	}
	...
	public EList<Tabla> getTheTabla() {
		if (theTabla == null) {
			theTabla = new EObjectContainmentWithInverseEList<Tabla>(Tabla.class, this, Relaciones1Package.SINTAXIS_ABSTRACTA__THE_TABLA, SintaxisabstractaPackage.TABLA__THESINTAXIS_ABSTRACTA);
		}
		return theTabla;
	}
	...
	public EList<SintaxisAbstracta> getSintaxisAbstracta() {
		if (sintaxisAbstracta == null) {
			sintaxisAbstracta = new EObjectResolvingEList<SintaxisAbstracta>(SintaxisAbstracta.class, this, Relaciones1Package.SINTAXIS_ABSTRACTA__SINTAXIS_ABSTRACTA);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetTheModelFactory((ModelFactory)otherEnd, msgs);
			case Relaciones1Package.SINTAXIS_ABSTRACTA__THE_TABLA:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Relaciones1Package.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY:
				return eInternalContainer().eInverseRemove(this, Relaciones1Package.MODEL_FACTORY__THESINTAXIS_ABSTRACTA, ModelFactory.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case Relaciones1Package.SINTAXIS_ABSTRACTA__THE_TABLA:
				return getTheTabla();
			case Relaciones1Package.SINTAXIS_ABSTRACTA__SINTAXIS_ABSTRACTA:
