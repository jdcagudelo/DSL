 ...
 * @generated
 */
public class Relaciones1PackageImpl extends EPackageImpl implements Relaciones1Package {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see relaciones1.Relaciones1Package#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Relaciones1PackageImpl() {
		super(eNS_URI, Relaciones1Factory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link Relaciones1Package#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Relaciones1Package init() {
		if (isInited) return (Relaciones1Package)EPackage.Registry.INSTANCE.getEPackage(Relaciones1Package.eNS_URI);

		// Obtain or create and register package
		Object registeredRelaciones1Package = EPackage.Registry.INSTANCE.get(eNS_URI);
		Relaciones1PackageImpl theRelaciones1Package = registeredRelaciones1Package instanceof Relaciones1PackageImpl ? (Relaciones1PackageImpl)registeredRelaciones1Package : new Relaciones1PackageImpl();
		...
		theRelaciones1Package.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Relaciones1Package.eNS_URI, theRelaciones1Package);
		return theRelaciones1Package;
	}
	 ...
	 * @generated
	 */
	public Relaciones1Factory getRelaciones1Factory() {
		return (Relaciones1Factory)getEFactoryInstance();
	}
