 ...
 * </p>
 * <ul>
 *   <li>{@link relaciones1.impl.SintaxisConcretaImpl#getTheModelFactory <em>The Model Factory</em>}</li>
 *   <li>{@link relaciones1.impl.SintaxisConcretaImpl#getTheTabla <em>The Tabla</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SintaxisConcretaImpl extends MinimalEObjectImpl.Container implements SintaxisConcreta {
	...
	protected EClass eStaticClass() {
		return Relaciones1Package.Literals.SINTAXIS_CONCRETA;
	}
	...
	public ModelFactory getTheModelFactory() {
		if (eContainerFeatureID() != Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY) return null;
	...
	public NotificationChain basicSetTheModelFactory(ModelFactory newTheModelFactory, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTheModelFactory, Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY, msgs);
		return msgs;
	}
	...
	public void setTheModelFactory(ModelFactory newTheModelFactory) {
		if (newTheModelFactory != eInternalContainer() || (eContainerFeatureID() != Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY && newTheModelFactory != null)) {
			...
			if (newTheModelFactory != null)
				msgs = ((InternalEObject)newTheModelFactory).eInverseAdd(this, Relaciones1Package.MODEL_FACTORY__THESINTAXIS_CONCRETA, ModelFactory.class, msgs);
			msgs = basicSetTheModelFactory(newTheModelFactory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY, newTheModelFactory, newTheModelFactory));
	}
	...
	public EList<Tabla> getTheTabla() {
		if (theTabla == null) {
			theTabla = new EObjectContainmentWithInverseEList<Tabla>(Tabla.class, this, Relaciones1Package.SINTAXIS_CONCRETA__THE_TABLA, SintaxisabstractaPackage.TABLA__THESINTAXIS_CONCRETA);
		}
		return theTabla;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetTheModelFactory((ModelFactory)otherEnd, msgs);
			case Relaciones1Package.SINTAXIS_CONCRETA__THE_TABLA:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case Relaciones1Package.SINTAXIS_CONCRETA__THE_MODEL_FACTORY:
				return eInternalContainer().eInverseRemove(this, Relaciones1Package.MODEL_FACTORY__THESINTAXIS_CONCRETA, ModelFactory.class, msgs);
		}
