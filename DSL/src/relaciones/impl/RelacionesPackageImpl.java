 ...
 * @generated
 */
public class RelacionesPackageImpl extends EPackageImpl implements RelacionesPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see relaciones.RelacionesPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RelacionesPackageImpl() {
		super(eNS_URI, RelacionesFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link RelacionesPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RelacionesPackage init() {
		if (isInited) return (RelacionesPackage)EPackage.Registry.INSTANCE.getEPackage(RelacionesPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredRelacionesPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		RelacionesPackageImpl theRelacionesPackage = registeredRelacionesPackage instanceof RelacionesPackageImpl ? (RelacionesPackageImpl)registeredRelacionesPackage : new RelacionesPackageImpl();
		...
		theRelacionesPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(RelacionesPackage.eNS_URI, theRelacionesPackage);
		return theRelacionesPackage;
	}
	 ...
	 * @generated
	 */
	public RelacionesFactory getRelacionesFactory() {
		return (RelacionesFactory)getEFactoryInstance();
	}
