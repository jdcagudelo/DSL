 ...
 * </p>
 * <ul>
 *   <li>{@link relaciones.impl.SintaxisConcretaImpl#getTheModelFactory <em>The Model Factory</em>}</li>
 *   <li>{@link relaciones.impl.SintaxisConcretaImpl#getTheTabla <em>The Tabla</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SintaxisConcretaImpl extends MinimalEObjectImpl.Container implements SintaxisConcreta {
	...
	protected EClass eStaticClass() {
		return RelacionesPackage.Literals.SINTAXIS_CONCRETA;
	}
	...
	public ModelFactory getTheModelFactory() {
		if (eContainerFeatureID() != RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY) return null;
	...
	public NotificationChain basicSetTheModelFactory(ModelFactory newTheModelFactory, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTheModelFactory, RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY, msgs);
		return msgs;
	}
	...
	public void setTheModelFactory(ModelFactory newTheModelFactory) {
		if (newTheModelFactory != eInternalContainer() || (eContainerFeatureID() != RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY && newTheModelFactory != null)) {
			...
			if (newTheModelFactory != null)
				msgs = ((InternalEObject)newTheModelFactory).eInverseAdd(this, RelacionesPackage.MODEL_FACTORY__THESINTAXIS_CONCRETA, ModelFactory.class, msgs);
			msgs = basicSetTheModelFactory(newTheModelFactory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY, newTheModelFactory, newTheModelFactory));
	}
	...
	public EList<Tabla> getTheTabla() {
		if (theTabla == null) {
			theTabla = new EObjectContainmentWithInverseEList<Tabla>(Tabla.class, this, RelacionesPackage.SINTAXIS_CONCRETA__THE_TABLA, SintaxisabstractaPackage.TABLA__THESINTAXIS_CONCRETA);
		}
		return theTabla;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetTheModelFactory((ModelFactory)otherEnd, msgs);
			case RelacionesPackage.SINTAXIS_CONCRETA__THE_TABLA:
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case RelacionesPackage.SINTAXIS_CONCRETA__THE_MODEL_FACTORY:
				return eInternalContainer().eInverseRemove(this, RelacionesPackage.MODEL_FACTORY__THESINTAXIS_CONCRETA, ModelFactory.class, msgs);
		}
