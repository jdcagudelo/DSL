 ...
 *   <li>{@link relaciones.impl.SintaxisAbstractaImpl#getListaRelaciones <em>Lista Relaciones</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SintaxisAbstractaImpl extends MinimalEObjectImpl.Container implements SintaxisAbstracta {
	...
	public EList<Relacion> getListaRelaciones() {
		if (listaRelaciones == null) {
			listaRelaciones = new EObjectContainmentWithInverseEList<Relacion>(Relacion.class, this, RelacionesPackage.SINTAXIS_ABSTRACTA__LISTA_RELACIONES, SintaxisabstractaPackage.RELACION__THESINTAXIS_ABSTRACTA);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case RelacionesPackage.SINTAXIS_ABSTRACTA__LISTA_RELACIONES:
