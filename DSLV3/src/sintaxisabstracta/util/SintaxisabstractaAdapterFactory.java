...
public class SintaxisabstractaAdapterFactory extends AdapterFactoryImpl {
	...
	protected SintaxisabstractaSwitch<Adapter> modelSwitch =
		new SintaxisabstractaSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDocumentAtrtribute(DocumentAtrtribute object) {
				return createDocumentAtrtributeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link sintaxisabstracta.DocumentAtrtribute <em>Document Atrtribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDocumentAtrtributeAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link sintaxisabstracta.Relacion <em>Relacion</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
