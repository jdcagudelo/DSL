...
public class SintaxisabstractaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SintaxisabstractaPackage.DOCUMENT_ATRTRIBUTE: {
				DocumentAtrtribute documentAtrtribute = (DocumentAtrtribute)theEObject;
				T result = caseDocumentAtrtribute(documentAtrtribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SintaxisabstractaPackage.RELACION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Document Atrtribute</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Document Atrtribute</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDocumentAtrtribute(DocumentAtrtribute object) {
		return null;
	}
