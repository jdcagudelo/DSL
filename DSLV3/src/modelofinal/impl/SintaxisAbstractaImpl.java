 ...
 * </p>
 * <ul>
 *   <li>{@link modelofinal.impl.SintaxisAbstractaImpl#getTheModelFactory <em>The Model Factory</em>}</li>
 *   <li>{@link modelofinal.impl.SintaxisAbstractaImpl#getTheTabla <em>The Tabla</em>}</li>
 *   <li>{@link modelofinal.impl.SintaxisAbstractaImpl#getSintaxisAbstracta <em>Sintaxis Abstracta</em>}</li>
 *   <li>{@link modelofinal.impl.SintaxisAbstractaImpl#getListaRelaciones <em>Lista Relaciones</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SintaxisAbstractaImpl extends MinimalEObjectImpl.Container implements SintaxisAbstracta {
	...
	protected EClass eStaticClass() {
		return ModelofinalPackage.Literals.SINTAXIS_ABSTRACTA;
	}
	...
	public ModelFactory getTheModelFactory() {
		if (eContainerFeatureID() != ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY) return null;
	...
	public NotificationChain basicSetTheModelFactory(ModelFactory newTheModelFactory, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTheModelFactory, ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY, msgs);
		return msgs;
	}
	...
	public void setTheModelFactory(ModelFactory newTheModelFactory) {
		if (newTheModelFactory != eInternalContainer() || (eContainerFeatureID() != ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY && newTheModelFactory != null)) {
			...
			if (newTheModelFactory != null)
				msgs = ((InternalEObject)newTheModelFactory).eInverseAdd(this, ModelofinalPackage.MODEL_FACTORY__THESINTAXIS_ABSTRACTA, ModelFactory.class, msgs);
			msgs = basicSetTheModelFactory(newTheModelFactory, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY, newTheModelFactory, newTheModelFactory));
	}
	...
	public EList<Tabla> getTheTabla() {
		if (theTabla == null) {
			theTabla = new EObjectContainmentWithInverseEList<Tabla>(Tabla.class, this, ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_TABLA, SintaxisabstractaPackage.TABLA__THESINTAXIS_ABSTRACTA);
		}
		return theTabla;
	}
	...
	public EList<SintaxisAbstracta> getSintaxisAbstracta() {
		if (sintaxisAbstracta == null) {
			sintaxisAbstracta = new EObjectResolvingEList<SintaxisAbstracta>(SintaxisAbstracta.class, this, ModelofinalPackage.SINTAXIS_ABSTRACTA__SINTAXIS_ABSTRACTA);
		}
	...
	public EList<Relacion> getListaRelaciones() {
		if (listaRelaciones == null) {
			listaRelaciones = new EObjectContainmentWithInverseEList<Relacion>(Relacion.class, this, ModelofinalPackage.SINTAXIS_ABSTRACTA__LISTA_RELACIONES, SintaxisabstractaPackage.RELACION__THESINTAXIS_ABSTRACTA);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetTheModelFactory((ModelFactory)otherEnd, msgs);
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_TABLA:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getTheTabla()).basicAdd(otherEnd, msgs);
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__LISTA_RELACIONES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getListaRelaciones()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_MODEL_FACTORY:
				return eInternalContainer().eInverseRemove(this, ModelofinalPackage.MODEL_FACTORY__THESINTAXIS_ABSTRACTA, ModelFactory.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__THE_TABLA:
				return getTheTabla();
			case ModelofinalPackage.SINTAXIS_ABSTRACTA__SINTAXIS_ABSTRACTA:
