...
/**
 * This is the item provider adapter for a {@link sintaxisabstracta.Campo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CampoItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Campo_etiqueta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Campo_etiqueta_feature", "_UI_Campo_type"),
				 SintaxisabstractaPackage.Literals.CAMPO__ETIQUETA,
				 true,
				 false,
				 false,
	...
	protected void addCodigoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Campo_codigo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Campo_codigo_feature", "_UI_Campo_type"),
				 SintaxisabstractaPackage.Literals.CAMPO__CODIGO,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SintaxisabstractaPackage.Literals.CAMPO__THE_TIPO_DATO);
		}
	...
	public String getText(Object object) {
		String label = ((Campo)object).getEtiqueta();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SintaxisabstractaPackage.Literals.CAMPO__THE_TIPO_DATO,
				 SintaxisabstractaFactory.eINSTANCE.createTipo_Dato()));

		newChildDescriptors.add
			(createChildParameter
				(SintaxisabstractaPackage.Literals.CAMPO__THE_TIPO_DATO,
				 SintaxisabstractaFactory.eINSTANCE.createString()));

		newChildDescriptors.add
			(createChildParameter
				(SintaxisabstractaPackage.Literals.CAMPO__THE_TIPO_DATO,
				 SintaxisabstractaFactory.eINSTANCE.createNumeric()));

		newChildDescriptors.add
			(createChildParameter
				(SintaxisabstractaPackage.Literals.CAMPO__THE_TIPO_DATO,
				 SintaxisabstractaFactory.eINSTANCE.createDate()));
	}
